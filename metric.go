...
var DataType = map[string]string{
	...
	"Handler_commit":				  DeltaPs,
	"Handler_delete":                 DeltaPs,
	"Handler_discover"                DeltaPs,
	"Handler_external_lock"           DeltaPs,
	"Handler_mrr_init"                DeltaPs,
	"Handler_prepare"                 DeltaPs,
	...
	"Handler_rollback"                DeltaPs,
	"Handler_savepoint"               DeltaPs,
	"Handler_savepoint_rollback"      DeltaPs,
